...
// Keep route feature code out of the shell chunk. In particular this prevents
// the device page's Three.js renderer and the camera/MediaPipe pages from being
// evaluated before the user opens those features.
const DeviceControl = lazy(() => import('../features/device-control').then(module => ({ default: module.DeviceControl })));
const SmartGrasp = lazy(() => import('../features/smart-grasp').then(module => ({ default: module.SmartGrasp })));
const VisionMimic = lazy(() => import('../features/vision').then(module => ({ default: module.VisionMimic })));
const RockPaperScissors = lazy(() => import('../features/rock-paper-scissors').then(module => ({ default: module.RockPaperScissors })));
const ActionCenter = lazy(() => import('../features/actions').then(module => ({ default: module.ActionCenter })));
const Diagnostics = lazy(() => import('../features/diagnostics').then(module => ({ default: module.Diagnostics })));
