...
- Vision asset checkout safeguard: `6dfb66c`, `8fddbad`.
...
- `pnpm check:vision-assets`: passed (5 offline assets, version 1.0.1, with required binary `.gitattributes` rules).
